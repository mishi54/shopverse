...
import { addToCartService, getMyCartService, removeCartItemService, updateCartItemService } from "../services/cartService.js";
...
const { productId } = req.params;
    ...
    res.status(200).json(new ApiResponse(200,result,"Cart item removed successfully"));
}
);
